...
namespace Personal_Project
{
    internal class Program
    {
        ...
        static void PokemonRPG()
        {
            ...
            Pokemon[] pokemon = new Pokemon[pokemonNum];
            ...
            string[] pokeindex = new string[pokemonNum];       // 1번 ~ 151번 도감 순, 0번 -> 피카츄(스타팅으로 고른 경우만)
            List<string> pokeIndexList = new List<string>();

            string[] lines = File.ReadAllLines("PokemonIndex.txt");
            ...
            /*
            string fileName = "PokemonIndex.txt";
            string filePath = $"{fileName}.txt";

            string pokeIndex = null;
            if (File.Exists(fileName))
            {
                Console.WriteLine("존재 함");
                pokeIndex = File.ReadAllText(filePath);
            }
            Console.WriteLine("존재 안 함");
            Console.WriteLine(pokeIndex);
            */
        }
...
/  \                                                                                                     |
    ...
    class Pokemon
    {
        ...
        public int[] condition = new int[10];           // 상태이상 (0: 독,  1: 맹독,  2: 얼음,  3: 마비,  4: 잠듦,  5: 화상,  6: 맹독 턴,  7: 잠듦 턴,  8: 혼란,  9: 혼란 턴,  10: 풀죽음
...
■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■");
        ...
        public void pokemonLabSetting()
        {
            ...
            map[10, 10] = 7;
            map[3, 10] = 1;
            map[2, 10] = map[4, 10] = map[3, 8] = map[3, 12] = 101;
...
■■■■■■■■■■ ■■■■■■■■■■");
    ...
    class Menu
    {
        ...
        public void menuCommon(MyPokemon myPokemon)        // 자신의 정보 보는 메뉴 창 (포켓몬, 가방, 지도, 다음 목표, 저장, 뒤로, 게임 종료)
        {
            int x = 0;
            int y = 0;
   ...
   뒤로");
        ...
        public void menuPokemon(MyPokemon myPokemon)
        {
            Console.Clear();
            for (int i = 0; i < 1; i++)
            {
